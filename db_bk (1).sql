...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Feb 2018 pada 13.18
...
--
ALTER TABLE `setup_sosiometri`
  MODIFY `id_sosiometri` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT untuk tabel `tbl_siswa_pelanggaran`
--
ALTER TABLE `tbl_siswa_pelanggaran`
  MODIFY `id_pelanggaran` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
